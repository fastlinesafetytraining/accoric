...
export default function NavBar(): React.ReactElement {
	...
	return (
		<>
			{isMobile ?  (
				// Mobile Navbar
				<nav className={styles.mobileNavBar} suppressHydrationWarning>
					<LuMenu className={styles.mobileNavBar__openIcon} onClick={showMenu} />
					<Drawer
						title={
						...
						footer={
							<div className={styles.mobileNavBar__drawerFooter}>
								<ThemeToggle />
				...
				// Desktop Navbar
				<nav className={styles.desktopNavBar} suppressHydrationWarning>
