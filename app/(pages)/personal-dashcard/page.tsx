...
import { DotPatternBackground } from "@components/UI";
import { SideBarAnchor, FAQSec, IntroSec, YourCardSec, YourCertificationSec, AccessAnywhereSec, AlwaysSyncSec, ExpirationReminderSec, PricingSec } from "@/containers/personal-dashcard-page";
