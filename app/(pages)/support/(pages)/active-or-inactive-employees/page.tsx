...
export default function Page() {
    return (
        <>
            <h1 id="employee-active-inactive-status">Employee Active/Inactive Status</h1>
            ...
            <ol>
                ...
                <li>
                    A green or grey outline will surround each employee&#39;s profile picture.
                    <br />
            ...
            <ol>
                <li>Navigate to <strong>Employee Profile</strong> Page.</li>
                <li>
                    Locate the <strong>Status</strong> box. Tick either the active or inactive radio button.
                    <Image
                        width={362}
                        height={231}
            ...
            <ol>
                ...
                <li>Locate the category in which the employee(s) you would like to edit are located.</li>
                <li>
                    From here, you may tick multiple employees at once. Scroll to the bottom of the list and change their status. Learn more about categories <a href="https://www.accoric.com/support/using-categories">in this page</a> to learn more about Categories.
                    <Image
                        width={1000}
                        height={1000}
